...
const issuedDocumentColumns = `
	...
	subtotal, total_igv, total_isc, total_other_taxes, total_discount, global_discount,
...
func documentScanDest(d *model.IssuedDocument, cuotasRaw, anticiposRaw, transporteCargaRaw, observationsRaw *[]byte) []any {
	return []any{
		...
		&d.Subtotal, &d.TotalIgv, &d.TotalIsc, &d.TotalOtherTaxes, &d.TotalDiscount, &d.GlobalDiscount,
